...
def set_args():
    ...
    parser.add_argument('--vocab_path', default='./model/gpt2_base/vocab.txt', type=str, help='词表，该词表为小词表，并增加了一些新的标记')
    parser.add_argument('--train_file_path', default='./data/train_data/train_data.json', type=str, help='新闻标题生成的训练数据')
    parser.add_argument('--test_file_path', default='./data/train_data/test_data.json', type=str, help='新闻标题生成的测试数据')
    parser.add_argument('--pretrained_model_path', default='./model/gpt2_base/', type=str, help='预训练的GPT2模型的路径')
    parser.add_argument('--data_dir', default='./tmp', type=str, help='生成缓存数据的存放路径')
    ...
    parser.add_argument('--output_dir', default='model/selfmodel/', type=str, help='模型输出路径')
