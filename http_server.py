...
def set_args():
    ...
    parser.add_argument('--output_dir', default='/opt/xiankai/GPT2-NewsTitle/model/openmodel', type=str, help='模型文件路径')
    ...
    parser.add_argument('--http_id', type=str, default="10.120.9.32", help='ip地址')
